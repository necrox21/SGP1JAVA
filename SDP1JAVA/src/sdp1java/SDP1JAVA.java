...
public class SDP1JAVA {
    ...
    static final int MAX = 10;//Valeur Max contenu dans la liste
    static final int TailleT = Aleatoire(); // Taille de la Liste principale
    ...
    public static void TriST(List<Integer> tab)//Tri Parallele ST
    {
        ...
        try {
            ...
            Logger.getLogger(SDP1JAVA.class.getName()).log(Level.SEVERE, null, ex);
